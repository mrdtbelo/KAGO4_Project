...
public class Config {
    ...
    public final static int WINDOW_WIDTH = 815;
    public final static int WINDOW_HEIGHT = 830;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
